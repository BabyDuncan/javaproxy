...
import com.babyduncan.proxy.dynamicProxy.cglib.BookServiceCglib;
...
public class CglibMain {
    ...
    public static void main(String... args) {
        ...
        BookService bookServiceProxy = (BookService) bookServiceCglib.getInstance(new BookServiceImpl());
